...
**Generated:** 2026-01-30 03:00:02 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
kube-system   5m16s       Warning   Unhealthy   pod/kube-apiserver-nlk8s-ctrl01   Readiness probe failed: HTTP probe failed with statuscode: 500
```
