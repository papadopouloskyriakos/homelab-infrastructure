...
**Generated:** 2026-02-16 03:00:01 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
kube-system   3m40s       Warning   Unhealthy   pod/kube-apiserver-nlk8s-ctrl01   Readiness probe failed: HTTP probe failed with statuscode: 500
```
