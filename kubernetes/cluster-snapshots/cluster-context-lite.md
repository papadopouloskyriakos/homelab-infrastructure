...
**Generated:** 2026-06-02 03:00:01 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
monitoring    3m12s       Warning   Unhealthy   pod/bgpalerter-596d7b756b-kngvb         Readiness probe failed: Get "http://10.0.6.173:8011/status": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
```
