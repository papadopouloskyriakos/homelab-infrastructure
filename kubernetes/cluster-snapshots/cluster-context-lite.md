...
**Generated:** 2026-08-07 03:00:01 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
### Unhealthy Pods
```
velero                   monitoring-default-kopia-maintain-job-1786071134976-bcf2n         0/1   Error       0                  8m41s
velero                   monitoring-default-kopia-maintain-job-1786071435055-sjdhd         0/1   Error       0                  3m41s
...
velero        8m38s       Warning   BackoffLimitExceeded   job/monitoring-default-kopia-maintain-job-1786071134976   Job has reached the specified backoff limit
kube-system   4m16s       Warning   Unhealthy              pod/etcd-nlk8s-ctrl01                               Readiness probe failed: Get "http://127.0.0.1:2381/readyz": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
velero        3m37s       Warning   BackoffLimitExceeded   job/monitoring-default-kopia-maintain-job-1786071435055   Job has reached the specified backoff limit
```
