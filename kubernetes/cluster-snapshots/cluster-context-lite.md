...
**Generated:** 2026-01-12 03:00:01 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
monitoring    12s         Warning   Unhealthy   pod/bgpalerter-596d7b756b-pxcb5         Readiness probe failed: Get "http://10.0.0.65:8011/status": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
```
