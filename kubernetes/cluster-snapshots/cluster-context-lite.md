...
**Generated:** 2026-04-14 03:00:01 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
monitoring    35m         Warning   Unhealthy   pod/bgpalerter-596d7b756b-dkn62           Readiness probe failed: Get "http://10.0.2.130:8011/status": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
argocd        22m         Warning   Unhealthy   pod/argocd-repo-server-7dfc645f84-nx2zg   Liveness probe failed: Get "http://10.0.2.167:8084/healthz?full=true": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
argocd        4m52s       Warning   Unhealthy   pod/argocd-repo-server-7dfc645f84-xzfj5   Liveness probe failed: Get "http://10.0.2.96:8084/healthz?full=true": context deadline exceeded (Client.Timeout exceeded while awaiting headers)
kube-system   2m          Warning   Unhealthy   pod/kube-apiserver-nlk8s-ctrl01     Readiness probe failed: HTTP probe failed with statuscode: 500
```
