...
**Generated:** 2026-08-25 03:00:01 UTC | **Host:** nlk8s-ctrl01 | **v3.1.0**
...
- **nlk8s-node01** (worker) 10.0.X.X | CPU:8 Mem:16246548Ki | Taints:none
...
### Unhealthy Pods
```
kube-system              kube-proxy-qn8md                                                  0/1   Error       182 (5m24s ago)   8d
velero                   awx-default-kopia-maintain-job-1787626089072-hvl9j                0/1   Error       0                 12m
velero                   awx-default-kopia-maintain-job-1787626389072-j479z                0/1   Error       0                 7m40s
velero                   awx-default-kopia-maintain-job-1787626689073-kjvx8                0/1   Error       0                 2m40s
velero                   monitoring-default-kopia-maintain-job-1787626093100-kksnr         0/1   Error       0                 12m
velero                   monitoring-default-kopia-maintain-job-1787626393102-nsjhp         0/1   Error       0                 7m36s
velero                   monitoring-default-kopia-maintain-job-1787626694102-pz94f         0/1   Error       0                 2m35s
velero                   pihole-default-kopia-maintain-job-1787626097137-wr6cz             0/1   Error       0                 12m
velero                   pihole-default-kopia-maintain-job-1787626397129-bbz2j             0/1   Error       0                 7m32s
velero                   pihole-default-kopia-maintain-job-1787626698132-ndxc2             0/1   Error       0                 2m31s
```
...
### Recent Warnings (5)
```
velero        7m30s       Warning   BackoffLimitExceeded   job/pihole-default-kopia-maintain-job-1787626397129       Job has reached the specified backoff limit
kube-system   4m7s        Warning   BackOff                pod/kube-proxy-qn8md                                      Back-off restarting failed container kube-proxy in pod kube-proxy-qn8md_kube-system(70ae08f5-7949-459c-9670-ac69c6b03a55)
velero        2m37s       Warning   BackoffLimitExceeded   job/awx-default-kopia-maintain-job-1787626689073          Job has reached the specified backoff limit
velero        2m33s       Warning   BackoffLimitExceeded   job/monitoring-default-kopia-maintain-job-1787626694102   Job has reached the specified backoff limit
velero        2m28s       Warning   BackoffLimitExceeded   job/pihole-default-kopia-maintain-job-1787626698132       Job has reached the specified backoff limit
```
