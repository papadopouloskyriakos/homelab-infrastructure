...
resource "kubernetes_manifest" "omoikane_container_memory_alert_rules" {
  manifest = {
    apiVersion = "monitoring.coreos.com/v1"
    kind       = "PrometheusRule"
    metadata = {
      name      = "omoikane-container-memory-alert-rules"
      ...
      groups = [
        {
          ...
          rules = [
            ...
            # -----------------------------------------------------------------
            {
              alert = "OmoikaneContainerOOMKilled"
            ...
            # -----------------------------------------------------------------
            {
              alert = "OmoikaneCgroupMetricsStale"
            ...
            {
              alert = "OmoikaneCgroupMetricsAbsent"
