...
resource "kubernetes_manifest" "omoikane_yb_backup_alert_rules" {
  manifest = {
    apiVersion = "monitoring.coreos.com/v1"
    kind       = "PrometheusRule"
    metadata = {
      name      = "omoikane-yb-backup-alert-rules"
      ...
      groups = [
        {
          ...
          rules = [
            ...
            {
              alert = "OmoikaneYbBackupCritical"
            ...
            # -----------------------------------------------------------------
            {
              alert = "OmoikaneYbBackupPermTruncation"
            ...
            # -----------------------------------------------------------------
            {
              alert = "OmoikaneYbBackupTooFewSnapshots"
            ...
            # -----------------------------------------------------------------
            {
              alert = "OmoikaneYbBackupMetricsAbsent"
